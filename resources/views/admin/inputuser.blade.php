   ...
   $('#form_upload').submit(
      function(event)
	  {
		 ...
		 (
	        {
               type: 'POST',
               url: '{{ route("admincontroller.do_inputuser") }}',
               data: formData,
               processData: false,
               contentType: false,
