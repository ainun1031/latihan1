									...
									<div class="form-horizontal">
										...
										<div class="clearfix form-actions">
											<div class="col-md-offset-3 col-md-9">
												<input class="btn btn-info" type="submit" value="Tambah Ujian" onclick='do_tambahujian()'>
											</div>
										</div>
									</div>
...
<script type="text/javascript">
   function do_tambahujian()
   {
	  ...
	  (
	    {
            type: 'POST',
            url: '{{ route("admincontroller.do_inputujian") }}',
            data: {post_namaujian:v_namaujian,post_informasiujian:v_informasiujian,post_maximalattempt:v_maximalattempt,post_bataswaktu:v_bataswaktu},
