...
<html lang="en">
	...
	<body class="no-skin" onLoad="viewdata_listuser()">
...
<script>
   ...
   {				
	  ...
	  ({
            type:'GET',
            url:'{{ route("admincontroller.viewdata_listuser") }}',
            data: {},
            success:function(xmlHttp)
			{
                ...
                if(len > 0)
				{
					...
					vhtml += "<table class='table table-striped table-bordered table-hover'>";
						vhtml += "<thead>";
							vhtml += "<tr>";
								vhtml += "<th>Username</th>";
								vhtml += "<th>Nama Lengkap</th>";
								vhtml += "<th>Email</th>";
								vhtml += "<th>Hak Akses</th>";
								vhtml += "<th>Aksi</th>";
							vhtml += "</tr>";
						vhtml += "</thead>";
						vhtml += "<tbody>";
						for(var i=0;i < (arr_retbuf.length-1); i++)
						{
							...
							var v_username = data_arr_retbuf[1];
							var v_namalengkap = data_arr_retbuf[2];
							var v_email = data_arr_retbuf[3];
							var v_hakakses = data_arr_retbuf[4];
							vhtml += "<tr>";
						  		vhtml += "<th>"+v_username+"</th>";
								vhtml += "<th>"+v_namalengkap+"</th>";
								vhtml += "<th>"+v_email+"</th>";
								vhtml += "<th>"+v_hakakses+"</th>";
								vhtml += "<th>";
									vhtml += "<div class='btn-group'>";
										...
										vhtml += "<ul class='dropdown-menu'>";
											vhtml += "<li>";
												vhtml += "<a style='cursor:pointer' onclick='view_updateuser("+v_id+")'>Update User</a>";
											vhtml += "</li>";
											vhtml += "<li>";
												vhtml += "<a style='cursor:pointer' onclick='do_deleteuser("+v_id+")'>Hapus User</a>";
											vhtml += "</li>";
										vhtml += "</ul>";
									vhtml += "</div>";
								vhtml += "</th>";
						...
						vhtml += "</tbody>";
					vhtml += "</table>";
					document.getElementById("div_listuser").innerHTML = vhtml;
                }
            }
      });
   }
   function view_updateuser(id_user)
   {
	   window.location = "{{ url('/admin/view_updateuser') }}?id="+id_user;
   }
   function do_deleteuser(id_user)
   {
      //messagebox
	  ...
	  if(vbox1 == true)
	  {
	     ...
	     ({
            type:'GET',
            url:'{{ route("admincontroller.do_deleteuser") }}',
