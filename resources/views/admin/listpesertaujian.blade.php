...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>List Peserta Ujian</title>
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">List Peserta Ujian</li>
						</ul><!-- /.breadcrumb -->
											...
											<th>
												<div class="btn-group">
													...
													<ul class="dropdown-menu">
														<li>
															<a href="/admin/do_hapuspesertaujian">Hapus</a>
														</li>
														<li>
															<a href="/admin/view_updategradingpesertaujian">Grading</a>
														</li>
													</ul>
												</div>
											</th>
