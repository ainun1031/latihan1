...
<html lang="en">
	...
	<body class="no-skin" onLoad="viewdata_listsoal()">
                ...
                if(len > 0)
				{
					...
					vhtml += "<table class='table table-striped table-bordered table-hover'>";
						vhtml += "<thead>";
							vhtml += "<tr>";
								vhtml += "<th>ID</th>";
								vhtml += "<th>Jenis Soal</th>";
								vhtml += "<th>Nama Soal</th>";
								vhtml += "<th>Teks Soal</th>";
								vhtml += "<th>Aksi</th>";
							vhtml += "</tr>";
						vhtml += "</thead>";
						vhtml += "<tbody>";
						for(var i=0;i < (arr_retbuf.length-1); i++)
						{
							...
							vhtml += "<tr>";
						  		vhtml += "<th>"+v_id+"</th>";
								vhtml += "<th>"+v_jenissoal+"</th>";
								vhtml += "<th>"+v_namasoal+"</th>";
								vhtml += "<th>"+v_tekssoal+"</th>";
								vhtml += "<th>";
									vhtml += "<div class='btn-group'>";
										...
										vhtml += "<ul class='dropdown-menu'>";
											vhtml += "<li>";
												vhtml += "<a style='cursor:pointer' onclick='view_updatesoalmultiplechoice("+v_id+")'>Update Soal</a>";
											vhtml += "</li>";
											vhtml += "<li>";
												vhtml += "<a style='cursor:pointer' onclick='do_deletesoalmultiplechoice("+v_id+")'>Hapus Soal</a>";
											vhtml += "</li>";
										vhtml += "</ul>";
									vhtml += "</div>";
								vhtml += "</th>";
						...
						vhtml += "</tbody>";
					vhtml += "</table>";
					document.getElementById("div_listsoal").innerHTML = vhtml;
                }
            }
      });
   }
   function view_updatesoalmultiplechoice(id_soal)
   {
	   window.location = "{{ url('/admin/view_updatesoalmultiplechoice') }}?id="+id_soal;
   }
   function do_deletesoalmultiplechoice(id_soal)
   {
      //messagebox
	  ...
	  if(vbox1 == true)
	  {
	     ...
	     ({
            type:'GET',
            url:'{{ route("admincontroller.do_deletesoalmultiplechoice") }}',
            ...
            success:function(xmlHttp)
			{
				...
				)
				{
					...
					{
					   message_content += "<h2>Delete Soal Kunci Jawaban Gagal</h2>";
					}
