...
<script>
   ...
   {				
	  ...
	  ({
            type:'GET',
            url:'{{ route("admincontroller.viewdata_listujian") }}',
            data: {},
							...
							vhtml += "<tr>";
								...
								vhtml += "<th>";
									vhtml += "<div class='btn-group'>";
										vhtml += "<button data-toggle='dropdown' class='btn btn-primary btn-white dropdown-toggle' aria-expanded='true'>";
											vhtml += "Aksi";
											vhtml += "<i class='ace-icon fa fa-angle-down icon-on-right'></i>";
										vhtml += "</button>";
										vhtml += "<ul class='dropdown-menu'>";
											vhtml += "<li>";
												vhtml += "<a style='cursor:pointer' onclick='view_updateujian("+v_id+")'>Update Ujian</a>";
											vhtml += "</li>";
											vhtml += "<li>";
												vhtml += "<a style='cursor:pointer' onclick='do_deleteujian("+v_id+")'>Hapus Ujian</a>";
											vhtml += "</li>";
											vhtml += "<li>";
												vhtml += "<a style='cursor:pointer' onclick='view_inputkonfigurasipenyajianujian("+v_id+")'>Konfigurasi Penyajian</a>";
											vhtml += "</li>";
											vhtml += "<li>";
												vhtml += "<a style='cursor:pointer' onclick='view_listpesertaujian("+v_id+")'>List Peserta Ujian</a>";
											vhtml += "</li>";
											vhtml += "<li>";
												vhtml += "<a style='cursor:pointer' onclick='do_aktivasiujian("+v_id+")'>Aktifkan/Nonaktifkan</a>";
											vhtml += "</li>";
										vhtml += "</ul>";
									vhtml += "</div>";
								vhtml += "</th>";
   ...
   function view_updateujian(id_ujian)
   {
	   window.location = "{{ url('/admin/view_updateujian') }}?id="+id_ujian;
   }
   function view_inputkonfigurasipenyajianujian(id_ujian)
   {
	   window.location = "{{ url('/admin/view_inputkonfigurasipenyajianujian') }}?id="+id_ujian;
   }
   function view_listpesertaujian(id_ujian)
   {
	   window.location = "{{ url('/admin/view_listpesertaujian') }}?id="+id_ujian;
   }
   function do_aktivasiujian(id_ujian)
   {
	  var v_statusaktif;
	  
      //messagebox
	  var vbox1 = confirm("Yes=Aktifkan No=Nonaktifkan");
	  ...
	  if(vbox1 == true)
	  {
	     ...
	     ({
            type:'GET',
            url:'{{ route("admincontroller.do_aktivasiujian") }}',
            data: {post_idujian:id_ujian,post_statusaktif:v_statusaktif},
            success:function(xmlHttp)
			{
                var len = 0;
                if(xmlHttp["respon"] != null)
                ...
                if(len > 0)
				{
					...
					if(retbuf=="update.gagal")
					{
					   ...
					   message_content += "<br>";
					   message_content += "<h2>Aktifkan Gagal</h2>";
					   message_content += "</center>";
					...
					if(retbuf=="update.berhasil")
					{
					   ...
					   message_content += "<br>";
					   message_content += "<h2>Aktifkan Berhasil</h2>";
					   message_content += "</center>";
					   document.getElementById("div_respon").innerHTML = message_content;
					}
            ...
            success:function(xmlHttp)
			{
                ...
                if(len > 0)
				{
					...
					if(retbuf=="update.gagal")
					{
					   ...
					   message_content += "<img src='{{ env('TEMPLATE_URL') }}/assets/images/fail.png' style='width:200px;height:200px;'>";
					   message_content += "<br>";
					   message_content += "<h2>Nonaktifkan Gagal</h2>";
					   message_content += "</center>";
					   document.getElementById("div_respon").innerHTML = message_content;
					}
					if(retbuf=="update.berhasil")
					{
					   ...
					   message_content += "<img src='{{ env('TEMPLATE_URL') }}/assets/images/success.png' style='width:200px;height:200px;'>";
					   message_content += "<br>";
					   message_content += "<h2>Nonaktifkan Berhasil</h2>";
					   message_content += "</center>";
					   document.getElementById("div_respon").innerHTML = message_content;
					}
					$('#modal_respon').modal('show');
   ...
   function do_deleteujian(id_ujian)
   {
      //messagebox
	  var vbox1 = confirm("Yes=Delete");
	  ...
	  if(vbox1 == true)
	  {
	     ...
	     ({
            type:'GET',
            url:'{{ route("admincontroller.do_deleteujian") }}',
            ...
            success:function(xmlHttp)
			{
                ...
                if(len > 0)
				{
                    var retbuf = xmlHttp["respon"];
					var message_content = "";
					if(retbuf=="delete.gagal")
					{
					   message_content += "<center>";
					   message_content += "<img src='{{ env('TEMPLATE_URL') }}/assets/images/fail.png' style='width:200px;height:200px;'>";
					   message_content += "<br>";
					   message_content += "<h2>Delete Gagal</h2>";
					   message_content += "</center>";
					   document.getElementById("div_respon").innerHTML = message_content;
					}
					if(retbuf=="delete.berhasil")
					{
					   message_content += "<center>";
					   message_content += "<img src='{{ env('TEMPLATE_URL') }}/assets/images/success.png' style='width:200px;height:200px;'>";
					   message_content += "<br>";
					   message_content += "<h2>Delete Berhasil</h2>";
					   message_content += "</center>";
					   document.getElementById("div_respon").innerHTML = message_content;
					   viewdata_listujian();
					}
