							...
							<div class="col-xs-12">
								...
								<div class="form-horizontal">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Nama Penyelenggara </label>
										<div class="col-sm-9">
											<input type="text" id="textbox_namapenyelenggara" placeholder="Nama Penyelenggara" class="form-control" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Email Penyelenggara </label>
										<div class="col-sm-9">
											<input type="text" id="textbox_emailpenyelenggara" placeholder="Email Penyelenggara" class="form-control" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Nomor Telepon Penyelenggara </label>
										<div class="col-sm-9">
											<input type="text" id="textbox_nomorteleponpenyelenggara" placeholder="Nomor Telepon Penyelenggara" class="form-control" />
										</div>
									</div>
