...
<html lang="en">
	...
	<body class="no-skin" onload="viewdata_updateujian()" >
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="/admin/view_inputpeserta">
									<i class="menu-icon fa fa-caret-right"></i>
									Input Peserta
								</a>
								<b class="arrow"></b>
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Update Ujian</li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="col-xs-12">
								...
								<div class="form-horizontal">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="textbox_namaujian" placeholder="Nama Ujian" class="form-control" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Informasi Ujian </label>
										<div class="col-sm-9">
											<textarea class="form-control" id="textbox_informasiujian" placeholder="Informasi Ujian" style="height: 125px;resize:none;"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Maximal Attempt</label>
										<div class="col-sm-9">
											<select class="form-control" id="combobox_maximalattepmt" placeholder="Maximal Attempt">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Batas Waktu (dalam detik) </label>
										<div class="col-sm-9">
											<input type="text" id="textbox_bataswaktu" placeholder="Batas Waktu (dalam detik)" class="form-control" />
										</div>
									</div>
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<input type="HIDDEN" id="textbox_idujian" name="textbox_idujian" placeholder="ID Ujian" class="form-control" />
											<input class="btn btn-info" type="submit" value="Update Ujian" onclick='do_updateujian()'>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
   function viewdata_updateujian()
   {
      var vparams = new URLSearchParams(window.location.search);
	  var id_ujian = vparams.get('id');
	  $.ajaxSetup
	  ({
            headers: 
			{
	  ...
	  ({
            type:'GET',
            url:'{{ route("admincontroller.viewdata_updateujian") }}',
            data: {post_id:id_ujian},
            success:function(xmlHttp)
			{
                ...
                if(len > 0)
				{
					...
					document.getElementById("textbox_namaujian").value = arr_retbuf[1];
					document.getElementById("textbox_informasiujian").value = arr_retbuf[2];
					document.getElementById("combobox_maximalattepmt").value = arr_retbuf[3];
					document.getElementById("textbox_bataswaktu").value = arr_retbuf[4];
					document.getElementById("textbox_idujian").value = id_ujian;
                }
            }
      });
   }
   
   function do_updateujian()
   {
	  var v_namaujian;
      var v_informasiujian;
	  var v_maximalattempt;
	  var v_bataswaktu;
      v_namaujian = document.getElementById("textbox_namaujian").value;
	  v_informasiujian = document.getElementById("textbox_informasiujian").value;
	  v_maximalattempt = document.getElementById("combobox_maximalattepmt").value;
	  v_bataswaktu = document.getElementById("textbox_bataswaktu").value;
      var vparams = new URLSearchParams(window.location.search);
	  var id_ujian = vparams.get('id');
      $.ajaxSetup
	  (
	  ...
	  (
	    {
            type: 'POST',
            url: '{{ route("admincontroller.do_updateujian") }}',
            data: {post_namaujian:v_namaujian,post_informasiujian:v_informasiujian,post_maximalattempt:v_maximalattempt,post_bataswaktu:v_bataswaktu,post_idujian:id_ujian},
            success:function(xmlHttp)
			{
               var len = 0;
               if(xmlHttp["respon"] != null)
               ...
               if(len > 0)
			   {
                  var retbuf = xmlHttp["respon"];
				  var message_content = "";
				  if(retbuf=="update.gagal")
				  {
					message_content += "<center>";
					message_content += "<img src='{{ env('TEMPLATE_URL') }}/assets/images/fail.png' style='width:200px;height:200px;'>";
					message_content += "<br>";
					message_content += "<h2>Update Gagal</h2>";
					message_content += "</center>";
					document.getElementById("div_respon").innerHTML = message_content;
				  }
				  if(retbuf=="update.berhasil")
				  {
					message_content += "<center>";
					message_content += "<img src='{{ env('TEMPLATE_URL') }}/assets/images/success.png' style='width:200px;height:200px;'>";
					message_content += "<br>";
					message_content += "<h2>Update Berhasil</h2>";
					message_content += "</center>";
					document.getElementById("div_respon").innerHTML = message_content;
				  }
