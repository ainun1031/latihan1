...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Input Soal Multiple Choice</title>
	...
	<body class="no-skin" onload="awal()">
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Form Input Soal Multiple Choice</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Form Input Soal Multiple Choice
							</h1>
						</div><!-- /.page-header -->
							...
							<div class="col-xs-12">
								...
								<div class="form-horizontal">
									...
									<div style='background-color:#F8F8F8;'>
										...
										<div class='form-group'>
											<label class='col-sm-3 control-label no-padding-right'>Teks Pilihan 1</label>
											<div class='col-sm-9'>
												<textarea class='form-control' id='textbox_tekspilihan1' placeholder='Teks Pilihan 1' style='height: 75px;resize:none;'></textarea>
											</div>
										</div>
										<div class='form-group'>
											<label class='col-sm-3 control-label no-padding-right'>Nilai</label>
											<div class='col-sm-9'>
												<select class='form-control' id='combobox_nilai1' placeholder='Nilai'>
										...
										<div class='form-group'>
											<label class='col-sm-3 control-label no-padding-right'>Umpan Balik</label>
											<div class='col-sm-9'>
												<textarea class='form-control' id='textbox_umpanbalik1' placeholder='Umpan Balik 1' style='height:75px;resize:none;'></textarea>
											</div>
										</div>
										<div class='form-group'>
											<br>
									...
									<div style='background-color:#F8F8F8;'>
										...
										<div class='form-group'>
											<label class='col-sm-3 control-label no-padding-right'>Teks Pilihan 2</label>
											<div class='col-sm-9'>
												<textarea class='form-control' id='textbox_tekspilihan2' placeholder='Teks Pilihan 2' style='height: 75px;resize:none;'></textarea>
											</div>
										</div>
										<div class='form-group'>
											<label class='col-sm-3 control-label no-padding-right'>Nilai</label>
											<div class='col-sm-9'>
												<select class='form-control' id='combobox_nilai2' placeholder='Nilai'>
													<option value='0'>0</option>
													<option value='-100'>-100</option>
													<option value='-99'>-99</option>
													<option value='-98'>-98</option>
										...
										<div class='form-group'>
											<label class='col-sm-3 control-label no-padding-right'>Umpan Balik</label>
											<div class='col-sm-9'>
												<textarea class='form-control' id='textbox_umpanbalik2' placeholder='Umpan Balik 2' style='height:75px;resize:none;'></textarea>
											</div>
										</div>
										<div class='form-group'>
											<br>
									...
									<div style='background-color:#F8F8F8;'>
										...
										<div class='form-group'>
											<label class='col-sm-3 control-label no-padding-right'>Teks Pilihan 3</label>
											<div class='col-sm-9'>
												<textarea class='form-control' id='textbox_tekspilihan3' placeholder='Teks Pilihan 3' style='height: 75px;resize:none;'></textarea>
											</div>
										</div>
										<div class='form-group'>
											<label class='col-sm-3 control-label no-padding-right'>Nilai</label>
											<div class='col-sm-9'>
												<select class='form-control' id='combobox_nilai3' placeholder='Nilai'>
													<option value='0'>0</option>
													<option value='-100'>-100</option>
													<option value='-99'>-99</option>
													<option value='-98'>-98</option>
										...
										<div class='form-group'>
											<label class='col-sm-3 control-label no-padding-right'>Umpan Balik</label>
											<div class='col-sm-9'>
												<textarea class='form-control' id='textbox_umpanbalik3' placeholder='Umpan Balik 3' style='height:75px;resize:none;'></textarea>
											</div>
										</div>
										<div class='form-group'>
											<br>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<input class="btn btn-info" type="submit" value="Tambah Soal Multiple Choice" onclick='do_tambahsoalmultiplechoice()'>
										</div>
									</div>
								</div>
...
<script>
	function awal()
	{
		document.getElementById('textbox_jumlahpilihanjawabansekarang').value = "4";
	}
	...
	function do_tambahsoalmultiplechoice()
	{
		var v_jenissoal;
		var v_namasoal;
		var v_tekssoal;
	    ...
	    (
	      {
              type: 'POST',
              url: '{{ route("admincontroller.do_tambahsoalmultiplechoice") }}',
              data: {post_jenissoal:v_jenissoal,post_namasoal:v_namasoal,post_tekssoal:v_tekssoal,post_pilihanjawaban:v_pilihanjawaban},
